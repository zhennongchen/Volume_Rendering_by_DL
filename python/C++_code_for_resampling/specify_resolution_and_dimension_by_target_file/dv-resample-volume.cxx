  ...
  switch (dv::ReadImageIOBase(IImage)->GetComponentType()) {
    case itk::ImageIOBase::UCHAR:
      dv::ResampleVolume<3, unsigned char>(
        IImage, OImage, spacing, spacingx, spacingy, spacingz, OImage_target, interpolator);
      break;
    case itk::ImageIOBase::CHAR:
      dv::ResampleVolume<3, char>(IImage, OImage, spacing, spacingx, spacingy, spacingz, OImage_target, interpolator);
      break;
    ...
    case itk::ImageIOBase::SHORT:
      dv::ResampleVolume<3, short>(IImage, OImage, spacing, spacingx, spacingy, spacingz, OImage_target, interpolator);
      break;
    ...
    case itk::ImageIOBase::INT:
      dv::ResampleVolume<3, int>(IImage, OImage, spacing, spacingx, spacingy, spacingz, OImage_target, interpolator);
      break;
    ...
    case itk::ImageIOBase::LONG:
      dv::ResampleVolume<3, long>(IImage, OImage, spacing, spacingx, spacingy, spacingz, OImage_target, interpolator);
      break;
    case itk::ImageIOBase::FLOAT:
      dv::ResampleVolume<3, float>(IImage, OImage, spacing, spacingx, spacingy, spacingz, OImage_target, interpolator);
      break;
    case itk::ImageIOBase::DOUBLE:
      dv::ResampleVolume<3, double>(IImage, OImage, spacing, spacingx, spacingy, spacingz, OImage_target, interpolator);
      break;
    default:
